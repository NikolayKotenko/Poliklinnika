...
//                    ?>
            ...
            <label>ФИО Лечащего врача
                <input type="text" name="ФИО Лечащего врача" value="<?=$post_null_get_article[$_GET['id']-1]['ФИО Лечащего врача']?>" class="form-item" autofocus required>
            </label><br>
            <label>Диагноз
            ...
            <label>Дата поступления
                <input type="date" name="Дата поступления" value="<?=$post_null_get_article[$_GET['id']-1]['Дата поступления']?>" class="form-item" autofocus required>
            </label><br>
            <label>Дата выписки
                <input type="date" name="Дата выписки" value="<?=$post_null_get_article[$_GET['id']-1]['Дата выписки']?>" class="form-item" autofocus required>
            </label><br>
            <label>Аллергия к препаратам
                <input type="text" name="Аллергия к препаратам" value="<?=$post_null_get_article[$_GET['id']-1]['Аллергия к препаратам']?>" class="form-item" autofocus required>
            </label><br>
            <label>Назначенные препараты
                <input type="text" name="Назначенные препараты" value="<?=$post_null_get_article[$_GET['id']-1]['Назначенные препараты']?>" class="form-item" autofocus required>
            </label><br>
